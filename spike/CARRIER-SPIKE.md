...
The kit contains synthetic fixtures only, so it can go to a TCR member or a design
partner with no §7216 or confidentiality question attached. That turns the Acrobat Pro
