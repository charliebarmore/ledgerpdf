...
# the machine. Real packaging is Phase 5 (see ROADMAP.md).
#
# NOTE: launcher.applescript hardcodes the repo path. If you move the repo,
# rebuild.
...
rm -rf "$APP"
osacompile -o "$APP" "$REPO/tools/launcher/launcher.applescript"
